...
public struct StateMachine<T: Hashable> {
    ...
    */
    public mutating func on(transition: Transition<T>, perform op: Operation) {
...
public extension StateMachine {
    ...
    - parameter perform: The operation the be performed.
    */
    public mutating func on(transitionFrom from: T, to: T, perform op: Operation) {
    ...
    - parameter perform: The operation the be performed.
    */
    public mutating func on(transitionFrom from: T, perform op: Operation) {
    ...
    - parameter perform: The operation the be performed.
    */
    public mutating func on(transitionTo to: T, perform op: Operation) {
