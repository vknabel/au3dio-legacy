...
public struct StateFlow<T: Hashable> {
    ...
    */
    public func allows(transition transition: Transition<T>) -> Bool {
...
public extension StateFlow {
    ...
    - parameter filter: An optional filter for transitions.
    */
    public mutating func allow(transitionFrom from: T, filter: TransitionFilter? = nil) {
    ...
    - parameter filter: An optional filter for transitions.
    */
    public mutating func allow(transitionTo to: T, filter: TransitionFilter? = nil) {
    ...
    - parameter filter: An optional filter for transitions.
    */
    public mutating func allow(transitionFrom from: T, to: T, filter: TransitionFilter? = nil) {
